...
const ctx=vm.createContext({
 chatTermReadHealth(){},AbortController,setTimeout,clearTimeout,fetch:async()=>({ok:true,json:async()=>tail}),chatTermFind:()=>null,renderChatInboxRows(){},document:{querySelector:()=>null},
