...
func (s *Server) handleArtifactText(w http.ResponseWriter, r *http.Request) {
	...
	if (a.Provenance.Source == "task-plan" || a.Provenance.Source == "knowledge-context" || a.Provenance.Source == "task-context" || a.Provenance.Source == "goal-context" || a.Provenance.Source == "person-context") || !strings.Contains("|.md|.txt|.json|.csv|.tsv|.yaml|.yml|.toml|.js|.jsx|.ts|.tsx|.py|.go|.html|.css|.sql|.sh|.xml|.svg|", "|"+ext+"|") || ext == "" {
